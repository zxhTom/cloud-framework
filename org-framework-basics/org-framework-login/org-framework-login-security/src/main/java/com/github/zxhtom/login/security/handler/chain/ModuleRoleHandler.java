 ...
 */
public class ModuleRoleHandler extends AbstractRoleUrlHandler<RequestBaseInfo, List<String>>  {
    @Autowired
    ModuleService moduleService;
    @Override
    public List<String> run(RequestBaseInfo requestBaseInfo) {
        List<Role> roleList = moduleService.selectWithRoleBaseOnModuleUrl(requestBaseInfo.getInterfaceUrl());
