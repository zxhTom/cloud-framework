...
import com.github.zxhtom.login.core.oauth2.exception.ErrorCodeConstants;
import com.github.zxhtom.login.core.oauth2.service.OAuth2CodeService;
import com.github.zxhtom.login.core.oauth2.service.OAuth2GrantService;
...
import static com.github.zxhtom.login.core.oauth2.exception.util.ServiceExceptionUtil.exception;
...
public class OAuth2GrantServiceImpl implements OAuth2GrantService {
    ...
    public OAuth2AccessTokenDO grantAuthorizationCodeForAccessToken(String clientId, String code,
        ...
        // 创建访问令牌
        return oauth2TokenService.createAccessToken(codeDO.getUserId(), 0,
    ...
    public OAuth2AccessTokenDO grantPassword(String username, String password, String clientId, List<String> scopes) {
        ...
        LoginResponse user = loginService.authenticateUser(loginRequest);
        Assert.notNull(user, "用户不能为空！"); // 防御性编程

        // 创建访问令牌
        return oauth2TokenService.createAccessToken(user.getUserId(), 0, clientId, scopes);
    }
    ...
    public OAuth2AccessTokenDO grantClientCredentials(String clientId, List<String> scopes) {
        return oauth2TokenService.createAccessToken(0L, 0, clientId, scopes);
    }
